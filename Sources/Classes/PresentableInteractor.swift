...
open class PresentableInteractor<DependencyType, PresentationLogicType>: Interactor<DependencyType> {

    /// The `Presenter` associated with this `Interactor`.
    public let presenter: PresentationLogicType
    ...
    public init(dependency: DependencyType, presenter: PresentationLogicType) {
